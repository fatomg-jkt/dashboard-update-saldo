...
export function BalanceDashboard() {
  ...
  return <main className="min-h-screen bg-slate-100 px-4 py-6 text-slate-900 lg:px-8"><div className="mx-auto max-w-7xl space-y-8">
    ...
    {editMode && <div className="flex flex-wrap gap-3"><button onClick={() => setQuickOpen(true)} className="rounded-2xl bg-emerald-600 px-5 py-3 font-bold text-white shadow-lg">Quick Update Saldo Hari Ini</button><button onClick={resetDefaultStructure} className="rounded-2xl bg-rose-600 px-5 py-3 font-bold text-white shadow-lg hover:bg-rose-700">Reset Struktur Brand Default</button></div>}
